...
* crowd sizes range from 10 to 500 people in steps of 10.
    * remember that crowd size here is not "the number of people at the 
    ...
    the less time you spend with each person. To do this right I should 
    probably make density a function of crowd size, and number of people
    exposed to a function of both density and total time. That is not what
    is done here.
...
The jaggedness of the lines is caused by the fact that n_thresh is required
to be an integer, so there is rounding happening.
